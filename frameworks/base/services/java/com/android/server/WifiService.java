...
public class WifiService extends IWifiManager.Stub {
    ...
    public boolean setWifiEnabled(boolean enable) {
        ...
        return setWifiEnabled_ex(enable);
    }

    public boolean setWifiEnabled_ex(boolean enable) {
    ...
    private boolean setWifiEnabledBlocking(boolean enable, boolean persist, int uid) {
        ...
        if (enable) {
            ...
            /* Fix: WIFI service miss ACTION_SCREEN_ON broadcast and set WIFI
            state to IDLE after resume */
            Slog.d(TAG, "setWifiEnabledBlocking");
     ...
     */
    public int getWifiEnabledState_ex() {
