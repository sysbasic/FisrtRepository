...
public class LightsService {
    ...
    static private final int MESSAGEWHAT_LED = 10;
    ...
    public final class Light {
         ...
         * @hide
         */
        public void turnOn(int onMS) {
            setLightLocked(0xff, LIGHT_FLASH_HARDWARE, onMS, 1000, BRIGHTNESS_MODE_USER);
            mH.removeMessages(MESSAGEWHAT_LED+mId);
            mH.sendMessageDelayed(Message.obtain(mH, MESSAGEWHAT_LED+mId, this), onMS);
        }
    ...
    private Handler mH = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if(msg.what == MESSAGEWHAT_LED+light.mId) {
                light.turnOff();
            } else {
                light.stopFlashing();
            }
