...
public class WindowManagerService extends IWindowManager.Stub
    ...
    boolean mShowMouseProp = false;     //"ro.showcursor"
    int mMlx;
    int mMly;
    int mMlw;
    int mMlh;
    ...
    private WindowManagerService(Context context, PowerManagerService pm,
        ...
        mShowMouseProp = "1".equals(SystemProperties.get(SYSTEM_SHOWCURSOR, "1"));
        mInputThread.start();
    ...
    private final class WindowState implements WindowManagerPolicy.WindowState {
        ...
        public boolean fillsScreenLw(int screenWidth, int screenHeight,
            ...
            if ((mAttrs.flags & FLAG_COMPATIBLE_WINDOW) != 0) {
                ...
                return frame.left <= mDisplay.getHdmiLeft() && frame.top <= mDisplay.getHdmiTop()
    ...
    private final void performLayoutAndPlaceSurfacesLockedInner(
        ...
        if (mShowMouseProp && mMouseSurface == null) {
            int mMx, mMy, mMw, mMh;
            Canvas mCanvas;
            Path mPath = new Path();
