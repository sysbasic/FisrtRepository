    ...
    private UEventObserver mUEventObserver = new UEventObserver() {
        ...
        public void onUEvent(UEventObserver.UEvent event) {
            ...
            if (newState == 2048) {
        		...
        		//intent.setAction("cn.livall.HdmiMgr.HdmiPlugInReceiver");
                intent.setAction("cn.livall.MonitorHdmi");
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                mContext.startActivity(intent);
        		//mContext.sendBroadcast(intent);
            }
            Slog.e("zhoukl", "UEvent=" + event.toString());
        }
    };
    ...
    public void systemReady() {
        synchronized (this) {
            ...
            if (isHDMIMode()) {
                ...
                //mWakeLock = powerManager.newWakeLock(PowerManager.FULL_WAKE_LOCK, "HDMI_WAKE-LOCK");
                //mWakeLock.acquire();
            
                // save to system property
                SystemProperties.set("persist.sys.hdmi_mode","1");
            } else {
                SystemProperties.set("persist.sys.hdmi_mode","0");
