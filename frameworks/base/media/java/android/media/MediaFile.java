...
public class MediaFile {
    ...
    public static final int FILE_TYPE_AVI     = 36;
    public static final int FILE_TYPE_RMVB    = 37;
    public static final int FILE_TYPE_RM	  = 38;
    public static final int FILE_TYPE_MKV	  = 39;
    public static final int FILE_TYPE_MPG	  = 40;
    public static final int FILE_TYPE_VOB	  = 41;
    public static final int FILE_TYPE_MOV	  = 42;
    public static final int FILE_TYPE_ASF	  = 43;
    public static final int FILE_TYPE_TS	  = 44;
	public static final int FILE_TYPE_TP	  = 45;
	public static final int FILE_TYPE_TRP	  = 46;
    public static final int FILE_TYPE_M2TS	  = 47;
    public static final int FILE_TYPE_FLV	  = 48;
    public static final int FILE_TYPE_DIVX	  = 49;
    public static final int FILE_TYPE_DAT	  = 50;
    public static final int FILE_TYPE_SVI	  = 51;
//	public static final int FILE_TYPE_NED	  = 52;//ned extension process
    private static final int FIRST_VIDEO_FILE_TYPE = FILE_TYPE_MP4;
    private static final int LAST_VIDEO_FILE_TYPE = FILE_TYPE_SVI;
    ...
    static {
        ...
        //if (SystemProperties.getInt("ro.media.dec.vid.rv.enabled", 0) != 0) {
