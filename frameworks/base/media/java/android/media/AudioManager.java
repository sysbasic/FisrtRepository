...
public class AudioManager {
    ...
    public void setStreamVolume(int streamType, int index, int flags) {
        IAudioService service = getService();
        try {
	    Log.d(TAG, "setStreamVolume :"+ streamType  + ". index :"+ index); 
    ...
    */
    ...
    public void setMode(int mode) {
		...
		setStreamVolume(STREAM_MUSIC, getStreamVolume(STREAM_MUSIC),0);	
	    } else
		setStreamVolume(STREAM_VOICE_CALL,getStreamVolume(STREAM_VOICE_CALL),0);
