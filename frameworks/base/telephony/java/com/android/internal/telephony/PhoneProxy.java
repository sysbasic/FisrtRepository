...
public class PhoneProxy extends Handler implements Phone {
    ...
    public void  enablePower(boolean enable) {
        mActivePhone.enablePower(enable);
    }
    
    public boolean isEnabledPower() {
        return mActivePhone.isEnabledPower();
    }

    public void keep3GAwaken(boolean keep)     {
        mActivePhone.keep3GAwaken(keep);
    }
    public boolean isKeep3GAwanek() {
        return mActivePhone.isKeep3GAwanek();
    }

    public int get3GSupportType() {
        return mActivePhone.get3GSupportType();
    }
