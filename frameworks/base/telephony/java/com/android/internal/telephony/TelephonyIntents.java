...
public class TelephonyIntents {
    ...
    /**
     * WirelessSettings.java switch KEEP_AWAKE, it will broadcast this message
     * @Hide
     */
    public static final String ACTION_KEEP_3G_AWAKEN_CHANGED
            = "android.intent.action.ACTION_KEEP_3G_AWAKEN_CHANGED";
