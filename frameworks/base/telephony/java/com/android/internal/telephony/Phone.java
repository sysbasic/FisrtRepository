...
public interface Phone {
    ...
    //void enableModemPower(boolean on);
    void enablePower(boolean on);
    boolean isEnabledPower();

    /**
     * Keep aliave
     *
     */
    void keep3GAwaken(boolean keep);
    boolean isKeep3GAwanek();

    /**
     * return 3G support type
     * GGGSUPORTTYPE_POWER: find internal modem
     * GGGSUPORTTYPE_VOICE: support Phone voice
     */
    // @Hide
    public static final int GGGSUPORTTYPE_POWER = 1<<0;
    public static final int GGGSUPORTTYPE_VOICE = 1<<1;
    int get3GSupportType();
