...
public abstract class WindowOrientationListener {
    ...
    class SensorEventListenerImpl implements SensorEventListener {
        ...
        private final int[] MAX_TRANSITION_TILT = new int[] {MAX_TILT, 65, 65, 40};
        ...
        private static final int TILTED_TIME_CONSTANT_MS = 100;
        // When device is under external acceleration, i.e. not just gravity.  We heavily distrust
        // such readings.
        private static final int ACCELERATING_TIME_CONSTANT_MS = 200;
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            float x = -event.values[_DATA_Y];
            float y = event.values[_DATA_X];
            float z = event.values[_DATA_Z];
