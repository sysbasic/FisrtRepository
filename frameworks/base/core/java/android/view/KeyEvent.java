...
public class KeyEvent implements Parcelable {
    ...
    public static final int KEYCODE_KP_7            = 94;
    public static final int KEYCODE_KP_8            = 95;
    public static final int KEYCODE_KP_9            = 96;
    public static final int KEYCODE_KP_MULTIPLY     = 97;
    public static final int KEYCODE_KP_4            = 98;
    public static final int KEYCODE_KP_5            = 99;
    public static final int KEYCODE_KP_6            = 100;
    public static final int KEYCODE_KP_MINUS        = 101;
    public static final int KEYCODE_KP_1            = 102;
    public static final int KEYCODE_KP_2            = 103;
    public static final int KEYCODE_KP_3            = 104;
    public static final int KEYCODE_KP_PLUS         = 105;
    public static final int KEYCODE_KP_0            = 106;
    public static final int KEYCODE_KP_DEL          = 107;
    public static final int KEYCODE_KP_ENTER        = 108;
    public static final int KEYCODE_KP_SLASH        = 109;
    public static final int KEYCODE_F1              = 110;
    public static final int KEYCODE_F2              = 111;
    public static final int KEYCODE_F3              = 112;
    public static final int KEYCODE_F4              = 113;
    public static final int KEYCODE_F5              = 114;
    public static final int KEYCODE_F6              = 115;
    public static final int KEYCODE_F7              = 116;
    public static final int KEYCODE_F8              = 117;
    public static final int KEYCODE_F9              = 118;
    public static final int KEYCODE_F10             = 119;
    public static final int KEYCODE_F11             = 120;
    public static final int KEYCODE_F12             = 121;
    public static final int KEYCODE_F13             = 122;
    public static final int KEYCODE_F14             = 123;
    public static final int KEYCODE_F15             = 124;
    public static final int KEYCODE_F16             = 125;
    public static final int KEYCODE_F17             = 126;
    public static final int KEYCODE_F18             = 127;
    public static final int KEYCODE_F19             = 128;
    public static final int KEYCODE_F20             = 129;
    public static final int KEYCODE_F21             = 130;
    public static final int KEYCODE_F22             = 131;
    public static final int KEYCODE_F23             = 132;
    public static final int KEYCODE_F24             = 133;
    public static final int KEYCODE_CAPS_LOCK       = 134;
    public static final int KEYCODE_NUM_LOCK        = 135;
    //Joystick(GamePad) support
    public static final int KEYCODE_BUTTON_UP       = 136;
    public static final int KEYCODE_BUTTON_RIGHT    = 137;
    public static final int KEYCODE_BUTTON_DOWN     = 138;
    public static final int KEYCODE_BUTTON_LEFT     = 139;
    public static final int KEYCODE_BUTTON_A        = 140;
    public static final int KEYCODE_BUTTON_B        = 141;
    public static final int KEYCODE_BUTTON_C        = 142;
    public static final int KEYCODE_BUTTON_X        = 143;
    public static final int KEYCODE_BUTTON_Y        = 144;
    public static final int KEYCODE_BUTTON_Z        = 145;
    public static final int KEYCODE_BUTTON_L1       = 146;
    public static final int KEYCODE_BUTTON_R1       = 147;
    public static final int KEYCODE_BUTTON_L2       = 148;
    public static final int KEYCODE_BUTTON_R2       = 149;
    public static final int KEYCODE_BUTTON_THUMBL   = 150;
    public static final int KEYCODE_BUTTON_THUMBR   = 151;
    public static final int KEYCODE_BUTTON_START    = 152;
    public static final int KEYCODE_BUTTON_SELECT   = 153;
    public static final int KEYCODE_BUTTON_MODE     = 154;
    public static final int KEYCODE_VOLUME_MUTE     = 155;

    private static final int LAST_KEYCODE           = KEYCODE_VOLUME_MUTE;
    /** @hide */
    public static final int KEYCODE_KEYLOCK         = KEYCODE_F22;
    public static final int KEYCODE_BEFORE_POWER    = KEYCODE_F23;
    public static final int KEYCODE_TOUCHCALIBRATE  = KEYCODE_F24;
    /**
