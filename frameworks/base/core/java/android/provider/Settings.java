...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        /**
         * GSensor calibration setting.
         * @hide
         */
    	public static final String GSENSOR_CALI_SETTING = "gsensor_calibration";
	    ...
	    /**
         * Internal MPCIE 3G power setting.
         * @hide
         */
        public static final String MPCIE_SETTING = "modem_on";

	    /**
         * Pre APK install complete.
         * @hide
         */
        public static final String preapk_installed_SETTING = "preapk_installed";

        /**
         * Keep awaken for Phone voice
         * @hide
         */

        public static final String MPCIE_KEEP_AWAKEN = "3g_keep_awaken";
	    /**
         * call MediaThumbRequest.execute() in MediaProvider.java
         * @hide
         */
        public static final String MEDIAPROVICER_THUMBREQUEST = "mediaprovicer_thumb";
