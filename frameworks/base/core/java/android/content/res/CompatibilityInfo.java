...
public class CompatibilityInfo {
    ...
    private static int mPortraitWidth = 0;
    private static int mPortraitHeight = 0;

    /**
     * The default width of the screen in portrait mode. 
     */
    public static final int DEFAULT_PORTRAIT_WIDTH = getPortiaitWidth();

    /**
     * The default height of the screen in portrait mode. 
     */    
    public static final int DEFAULT_PORTRAIT_HEIGHT = getPortiaitHeight();
    ...
    private static void getLCDWidthHeight() {
        int width = Display.getDisplayWidth(Display.DEFAULT_DISPLAY);
        int height = Display.getDisplayHeight(Display.DEFAULT_DISPLAY);
        if(width > height) {
        ...
        //Log.i(TAG, String.format("%dx%d", mPortraitWidth, mPortraitHeight));
    }
    private static int getPortiaitWidth() {
        if(mPortraitWidth == 0) getLCDWidthHeight();
        return mPortraitWidth==0?480:mPortraitWidth;
    }
    private static int getPortiaitHeight() {
        if(mPortraitHeight == 0) getLCDWidthHeight();
        return mPortraitHeight==0?800:mPortraitHeight;
    }
}
