    ...
    public boolean onTransact(int code, Parcel data, Parcel reply, int flags)
        ...
        try {
            switch (code) {
                ...
                {
                    data.enforceInterface(IContentProvider.descriptor);
                    Uri urls[] = data.createTypedArray(Uri.CREATOR);
                    String selection = data.readString();
                    String[] selectionArgs = data.readStringArray();

                    int count = bulkDelete(urls, selection, selectionArgs);
...
final class ContentProviderProxy implements IContentProvider
{
    ...
    public int bulkDelete(Uri[] urls, String selection, String[] selectionArgs)
            throws RemoteException {
        ...
        data.writeTypedArray(urls, 0);
        data.writeString(selection);
        data.writeStringArray(selectionArgs);

        mRemote.transact(IContentProvider.BULK_DELETE_TRANSACTION, data, reply, 0);
