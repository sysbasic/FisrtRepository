...
public class StorageManager
{
    ...
    public boolean isInternalUsbMassStorageConnected() {
        try {
            return mMountService.isInternalUsbMassStorageConnected();
        } catch (Exception ex) {
            Log.e(TAG, "Failed to get Internal UMS connection state", ex);
        }
        return false;
    }
    ...
    public boolean isUsbMassStorageEnabled() {
        try {
            ...
            Log.e(TAG, "Failed to get External UMS enable state", rex);
        }
        return false;
    }
    /*hengai */
    public boolean isInternalUsbMassStorageEnabled() {
        try {
            return mMountService.isInternalUsbMassStorageEnabled();
        } catch (RemoteException rex) {
            Log.e(TAG, "Failed to get Internal UMS enable state", rex);
        }
        return false;
    }    
}
