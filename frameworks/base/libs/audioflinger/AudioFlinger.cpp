...
bool AudioFlinger::RecordThread::threadLoop()
{
    ...
    while (!exitPending()) {
        ...
        if (mActiveTrack != 0) {
            ...
            // hengai: Change the request buffer size to RecordTrack
            if(mReqSampleRate < mSampleRate)
                buffer.frameCount = mFrameCount * mReqSampleRate / mSampleRate;
            else
            ...
            // client isn't retrieving buffers fast enough
                ...
                if (!mActiveTrack->setOverflow()) {
                    // hengai. Record samplerate is 44.1K, it always cause overflow
