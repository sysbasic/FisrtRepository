...
static const int32_t GAMEPAD_KEYCODES[] = {
        kKeyCodeButtonA, kKeyCodeButtonB, kKeyCodeButtonC,
        kKeyCodeButtonX, kKeyCodeButtonY, kKeyCodeButtonZ,
        kKeyCodeButtonL1, kKeyCodeButtonR1,
        kKeyCodeButtonL2, kKeyCodeButtonR2,
        kKeyCodeButtonTHUMBL, kKeyCodeButtonTHUMBR,
        kKeyCodeButtonStart, kKeyCodeButtonSelect, kKeyCodeButtonMode
};
